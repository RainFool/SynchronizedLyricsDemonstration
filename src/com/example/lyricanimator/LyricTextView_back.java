...
public class LyricTextView_back extends TextView {
    ...
    public interface AnimationSetupCallback {
        public void onSetupAnimation(LyricTextView_back titanicTextView);
    }
    ...
    */ 
    ...
    public LyricTextView_back(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LyricTextView_back(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (!setUp) {
            ...
            if (animationSetupCallback != null) {
                animationSetupCallback.onSetupAnimation(LyricTextView_back.this);
            }
        }
    }
